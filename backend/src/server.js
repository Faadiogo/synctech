...
app.use('/api/tipos-escopo-supabase', require('./routes/tipos-escopo-supabase'));
app.use('/api/nivel1-supabase', require('./routes/nivel1-supabase'));
app.use('/api/funcionalidades-supabase', require('./routes/funcionalidades-supabase'));
app.use('/api/subfuncionalidades-supabase', require('./routes/subfuncionalidades-supabase'));
app.use('/api/subitens-supabase', require('./routes/subitens-supabase'));
