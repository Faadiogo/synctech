...
import { tarefasService } from '@/lib/services/tarefasService';
...
export function TaskForm({ onClose, taskId }: TaskFormProps) {
  ...
  const loadTaskData = async () => {
    ...
    try {
      const response = await tarefasService.buscarPorId(taskId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (taskId) {
        await tarefasService.atualizar(taskId, taskData);
        toast({
          title: "Sucesso",
          description: "Tarefa atualizada com sucesso!",
        });
      } else {
        await tarefasService.criar(taskData);
        toast({
          title: "Sucesso",
