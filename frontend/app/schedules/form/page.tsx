...
export function ScheduleForm({ onClose, scheduleId }: ScheduleFormProps) {
  ...
  const loadScheduleData = async () => {
    ...
    try {
      const response = await cronogramaService.buscarPorId(scheduleId);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (scheduleId) {
        await cronogramaService.atualizar(scheduleId, scheduleData);
        toast({
          title: "Sucesso",
          description: "Cronograma atualizado com sucesso!",
        });
      } else {
        await cronogramaService.criar(scheduleData);
        toast({
          title: "Sucesso",
